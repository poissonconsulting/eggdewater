...
test_that("spawn-timing", {
  ...
  expect_identical(colnames(data), c("Date", "Value", "MeanSpawnDate"))
  expect_identical(data$Date, seq(as.Date("1999-12-30"), as.Date("2000-01-03"), by = "days"))
...
test_that("spawn-timing", {
  ...
  expect_identical(data$Date[1], as.Date("2000-03-26"))
